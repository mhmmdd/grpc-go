...
#openssl req -passin pass:1111 -new -x509 -days 3650 -key ca.key -out ca.crt -subj "//CN=${SERVER_CN}" # for windows
...
#openssl req -passin pass:1111 -new -key server.key -out server.csr -subj "//CN=${SERVER_CN}" # for windows
